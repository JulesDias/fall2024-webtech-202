...
export default function LoginNativePage() {
  ...
  return (
    <div className="flex items-center justify-center min-auto bg-gray-100 dark:bg-gray-900 rounded-3xl">
        ...
        {/* Formulaire principal */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
              className="w-full px- py-2 border rounded-md bg-gray-50 text-gray-900 dark:bg-gray-700 dark:text-gray-100 mb-4"
            />
